...
async def get_flag(client: httpx.AsyncClient,  # <1>
    ...
    resp = await client.get(url, timeout=3.1, allow_redirects=True)   # <2>
...
async def get_country(client: httpx.AsyncClient,
    ...
    resp = await client.get(url, timeout=3.1, allow_redirects=True)
    resp.raise_for_status()
...
async def supervisor(cc_list: List[str],
    ...
    async with httpx.AsyncClient() as client:
        ...
        error: Optional[httpx.HTTPError] = None  # <6>
